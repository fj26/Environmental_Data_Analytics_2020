...
> Answer: There are significant interactions between depth and some lakenames - not all lakenames have a significant interaction with depth, for example, Paul Lake. According to the adjusted R-squared, there is about 78.57% observed variance explained in this model (linear regression, adjusted R2 = 0.7857, dF = 9704, p < 0.0001 ).
...
> Answer: Yes, the mixed effects model better, because AIC value for the mixed effects model is higher.