...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{NTLraw <-}\StringTok{ }\KeywordTok{read.csv}\NormalTok{(}\StringTok{'./Data/Raw/NTL-LTER_Lake_ChemistryPhysics_Raw.csv'}\NormalTok{)}
...
\begin{Highlighting}[]
\CommentTok{#3}
\NormalTok{NTLsel <-}\StringTok{ }
\StringTok{  }\NormalTok{NTLraw }\OperatorTok{%>%}
...
\CommentTok{#4}
\NormalTok{TEMPAIC <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\DataTypeTok{data=}\NormalTok{NTLsel, temperature_C }\OperatorTok{~}\StringTok{ }\NormalTok{year4 }\OperatorTok{+}\StringTok{ }\NormalTok{daynum }\OperatorTok{+}\StringTok{ }\NormalTok{depth)}
...
\begin{Highlighting}[]
\CommentTok{#6}
\NormalTok{NTLinter <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\DataTypeTok{data=}\NormalTok{NTLsel, temperature_C }\OperatorTok{~}\StringTok{ }\NormalTok{depth }\OperatorTok{*}\StringTok{ }\NormalTok{lakename)}
\KeywordTok{summary}\NormalTok{(NTLinter)}
\end{Highlighting}
\end{Shaded}
